...
--
-- Host: localhost    Database: db_erv
-- ------------------------------------------------------
...
INSERT INTO `ascensos` VALUES (1,'N/A',1,1,'2024-04-19 17:44:22','2024-04-19 17:44:22');
...
CREATE TABLE `carritos` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `carritos_users_id_foreign` (`users_id`),
  KEY `carritos_status_id_foreign` (`status_id`),
  CONSTRAINT `carritos_status_id_foreign` FOREIGN KEY (`status_id`) REFERENCES `estatus` (`id`) ON DELETE CASCADE,
  CONSTRAINT `carritos_users_id_foreign` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `detalle_carritos` (
  ...
  KEY `detalle_carritos_producto_id_foreign` (`producto_id`),
  CONSTRAINT `detalle_carritos_carrito_id_foreign` FOREIGN KEY (`carrito_id`) REFERENCES `carritos` (`id`) ON DELETE CASCADE,
  CONSTRAINT `detalle_carritos_producto_id_foreign` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `detalle_facturas` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `detalle_facturas_facturas_id_foreign` (`facturas_id`),
  KEY `detalle_facturas_producto_id_foreign` (`producto_id`),
  CONSTRAINT `detalle_facturas_facturas_id_foreign` FOREIGN KEY (`facturas_id`) REFERENCES `facturas` (`id`) ON DELETE CASCADE,
...
--
-- Table structure for table `directivas`
--
...
CREATE TABLE `directivas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nombre` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cargos_id` bigint unsigned NOT NULL,
  `personas_id` bigint unsigned NOT NULL,
  `activo` tinyint(1) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `directivas_nombre_unique` (`nombre`),
  KEY `directivas_cargos_id_foreign` (`cargos_id`),
  KEY `directivas_personas_id_foreign` (`personas_id`),
  CONSTRAINT `directivas_cargos_id_foreign` FOREIGN KEY (`cargos_id`) REFERENCES `cargos` (`id`),
  CONSTRAINT `directivas_personas_id_foreign` FOREIGN KEY (`personas_id`) REFERENCES `personas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `directivas`
--

LOCK TABLES `directivas` WRITE;
/*!40000 ALTER TABLE `directivas` DISABLE KEYS */;
/*!40000 ALTER TABLE `directivas` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `estatus` VALUES (1,'Activo',1,'2024-04-19 17:44:22','2024-04-19 17:44:22'),(2,'Inactivo',1,'2024-04-19 17:44:22','2024-04-19 17:44:22');
...
CREATE TABLE `facturas` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `facturas_users_id_foreign` (`users_id`),
  KEY `facturas_status_id_foreign` (`status_id`),
  CONSTRAINT `facturas_status_id_foreign` FOREIGN KEY (`status_id`) REFERENCES `estatus` (`id`) ON DELETE CASCADE,
  CONSTRAINT `facturas_users_id_foreign` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` VALUES (34,'2014_10_12_100000_create_password_resets_table',1),(35,'2019_12_14_000001_create_personal_access_tokens_table',1),(36,'2023_08_19_000000_create_failed_jobs_table',1),(37,'2023_10_01_000000_create_statuses_table',1),(38,'2023_10_07_000000_create_type_promotions_table',1),(39,'2023_10_08_000000_create_promotions_table',1),(40,'2023_10_10_000000_create_type_people_table',1),(41,'2023_10_11_000000_create_people_table',1),(42,'2023_10_11_000000_create_permission_tables',1),(43,'2023_10_12_000000_create_users_table',1),(44,'2023_10_12_100000_create_password_reset_tokens_table',1),(45,'2023_12_14_000001_create_personal_access_tokens_table',1),(46,'2023_12_28_043619_create_zones_table',1),(47,'2023_12_28_043633_create_subzones_table',1),(48,'2023_12_28_043938_create_configs_table',1),(49,'2024_01_09_000000_create_categorias_table',1),(50,'2024_01_09_000000_create_cuotaszonas_table',1),(51,'2024_01_09_215548_create_reporte_pagos_table',1),(52,'2024_01_15_013703_create_banners_table',1),(53,'2024_01_15_013710_create_galerias_table',1),(54,'2024_01_15_013725_create_posts_table',1),(55,'2024_01_15_013731_create_categorias_posts_table',1),(56,'2024_01_15_013746_create_comentarios_table',1),(57,'2024_01_15_013750_create_comentarios_posts_table',1),(58,'2024_01_23_231106_create_eventos_table',1),(59,'2024_01_31_225029_create_pedidos_table',1),(60,'2024_01_31_225336_create_carritos_table',1),(61,'2024_01_31_225410_create_facturas_table',1),(62,'2024_02_05_000000_create_productos_table',1),(63,'2024_02_05_014323_create_categorias_productos_table',1),(64,'2024_02_06_000000_create_detalle_carritos_table',1),(65,'2024_02_06_000000_create_detalle_facturas_table',1),(66,'2024_02_06_000000_create_detalle_pedidos_table',1),(67,'2024_03_21_010718_create_payments_table',1),(68,'2024_04_14_181207_cargos',1),(69,'2024_04_14_181231_directivas',2);
...
CREATE TABLE `payments` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `payments_pedido_id_foreign` (`pedido_id`),
  KEY `payments_estatus_id_foreign` (`estatus_id`),
  CONSTRAINT `payments_estatus_id_foreign` FOREIGN KEY (`estatus_id`) REFERENCES `estatus` (`id`),
  CONSTRAINT `payments_pedido_id_foreign` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `pedidos_status_id_foreign` FOREIGN KEY (`status_id`) REFERENCES `estatus` (`id`) ON DELETE CASCADE,
...
INSERT INTO `permissions` VALUES (1,'view-report','web','2024-04-19 17:44:22','2024-04-19 17:44:22'),(2,'create-report','web','2024-04-19 17:44:22','2024-04-19 17:44:22'),(3,'download-report','web','2024-04-19 17:44:22','2024-04-19 17:44:22'),(4,'view-generate','web','2024-04-19 17:44:22','2024-04-19 17:44:22'),(5,'manage-config','web','2024-04-19 17:44:22','2024-04-19 17:44:22'),(6,'manage-config-users','web','2024-04-19 17:44:22','2024-04-19 17:44:22'),(7,'manage-config-permissions','web','2024-04-19 17:44:22','2024-04-19 17:44:22');
...
INSERT INTO `personas` VALUES (1,'Administrador','Admin','2024-04-19','Masculino','12345678','alexander20012@hotmail.com','+584123082432','caracas',1,1,1,'2024-04-19 17:44:22','2024-04-19 17:44:22');
...
INSERT INTO `roles` VALUES (1,'user','web','2024-04-19 17:44:22','2024-04-19 17:44:22'),(2,'supervisor','web','2024-04-19 17:44:22','2024-04-19 17:44:22'),(3,'moderator','web','2024-04-19 17:44:22','2024-04-19 17:44:22'),(4,'administrator','web','2024-04-19 17:44:22','2024-04-19 17:44:22');
...
INSERT INTO `tipo_ascensos` VALUES (1,'N/A',1,'2024-04-19 17:44:21','2024-04-19 17:44:21');
...
INSERT INTO `tipo_personas` VALUES (1,'Sistema',1,'2024-04-19 17:44:22','2024-04-19 17:44:22'),(2,'Usuario',1,'2024-04-19 17:44:22','2024-04-19 17:44:22');
...
INSERT INTO `users` VALUES (1,'Admin','$2y$12$xhizYCM8eqmqPwGaoG3S6eKty.pMJPNF3I6PdhCxEOytht43u6xCK',NULL,1,1,'2024-04-19 17:44:23','2024-04-19 17:44:23');
...
--
-- Dumping routines for database 'db_erv'
--
...
-- Dump completed on 2024-04-19 19:06:23
